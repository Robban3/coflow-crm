...
Kan vi ta 15 min nästa vecka för att gå igenom de snabbaste förbättringarna?`,
    ...
    "settings.senderFallbackName": "Applabbet",
    "settings.companyName": "Företagsnamn",
    "settings.marketAccessTitle": "Marknadsåtkomst per användare",
    "settings.marketAccessDesc": "Slå på/av vilka marknader varje användare ser under prospektering. Avstängda marknader döljs för användaren.",
    "settings.marketAccessUser": "Användare",
...
Vi hjälper företag att fokusera på sin kärnverksamhet medan vi tar hand om IT:n.`,
    ...
    "settings.leadCapLabel": "Max antal öppna leads per användare",
    "settings.leadCapDesc": "Hur många öppna leads en användare kan ha tilldelade samtidigt. Förhindrar att man samlar på sig leads utan att jobba med dem.",
    "settings.leadCapSave": "Spara",
    "settings.leadCapSaved": "Lead-tak sparat",
    "settings.leadCapSaveError": "Kunde inte spara lead-taket",
...
Can we take 15 minutes next week to go through the quickest improvements?`,
    ...
    "settings.marketAccessTitle": "Market access per user",
    "settings.marketAccessDesc": "Enable/disable which markets each user sees in prospecting. Disabled markets are hidden for that user.",
    "settings.marketAccessUser": "User",
...
We help companies focus on their core business while we take care of the IT.`,
    ...
    "settings.leadCapLabel": "Max open leads per user",
    "settings.leadCapDesc": "How many open leads a user can have assigned at once. Prevents hoarding leads without working them.",
    "settings.leadCapSave": "Save",
    "settings.leadCapSaved": "Lead cap saved",
    "settings.leadCapSaveError": "Could not save the lead cap",
...
¿Podemos dedicar 15 minutos la próxima semana para repasar las mejoras más rápidas?`,
    ...
    "settings.marketAccessTitle": "Acceso a mercados por usuario",
    "settings.marketAccessDesc": "Activa/desactiva qué mercados ve cada usuario en la prospección. Los mercados desactivados se ocultan para ese usuario.",
    "settings.marketAccessUser": "Usuario",
...
Ayudamos a las empresas a centrarse en su actividad principal mientras nosotros nos encargamos de la IT.`,
    ...
    "settings.leadCapLabel": "Máx. leads abiertos por usuario",
    "settings.leadCapDesc": "Cuántos leads abiertos puede tener asignados un usuario a la vez. Evita acumular leads sin trabajarlos.",
    "settings.leadCapSave": "Guardar",
    "settings.leadCapSaved": "Límite de leads guardado",
    "settings.leadCapSaveError": "No se pudo guardar el límite de leads",
