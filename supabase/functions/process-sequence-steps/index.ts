...
` : "Ingen webbanalys genomförd ännu.";
            ...
            const market: "SE" | "US" | "DE" | "ES" | "UK" | "KR" | "CA" | "AU" | "IE" =
              (leadSequence.sequence?.market as "SE" | "US" | "DE" | "ES" | "UK" | "KR" | "CA" | "AU" | "IE") || "SE";
...
${useSavedSignature ? `Saved signature (in ${market === "SE" ? "Swedish" : (market === "US" || market === "UK" || market === "CA" || market === "AU" || market === "IE") ? "English" : market === "ES" ? "Spanish" : market === "KR" ? "Korean" : "German"}, may be appended verbatim): ${profile.email_signature}` : "(No localized signature available — close the body without a signature; one will be appended automatically.)"}
` : "";
...
${signatureContext}`,
            ...
            const systemPrompt = systemPromptByMarket[(market === "UK" || market === "KR" || market === "CA" || market === "AU" || market === "IE") ? "US" : market]
...
{"subject": "Betreff hier", "body": "E-Mail-Text hier"}`,
            ...
            const emailContext = userPromptByMarket[(market === "UK" || market === "KR" || market === "CA" || market === "AU" || market === "IE") ? "US" : market];
            ...
            if (useSavedSignature) {
              ...
              emailContent.body += `\n\n${closingByMarket[(market === "UK" || market === "CA" || market === "AU" || market === "IE") ? "US" : market]}\n${senderName}`.trimEnd();
            }
