-- Allow South Korea (KR) as a market for outreach sequences.
-- The previous constraint (20260702130000) limited market to SE/US/DE/ES/UK.
...
ALTER TABLE public.outreach_sequences ADD CONSTRAINT outreach_sequences_market_check
  CHECK (market IN ('SE', 'US', 'DE', 'ES', 'UK', 'KR'));
